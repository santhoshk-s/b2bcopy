    ...
    <div className="container mx-auto p-4">
      <div className="flex flex-col md:flex-row gap-4">
        <div className="md:w-2/3">
          <div className="bg-white shadow-md rounded-lg overflow-hidden border border-gray-300 mt-8">
            <div className="p-4">
              {order.orderItems.length === 0 ? (
                <Messsage>No items in this order</Messsage>
              ) : (
          ...
          <div className="bg-white shadow-md rounded-lg p-4 border border-gray-300">
            ...
            {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
              <div>
                <button
                  type="button"
                  className="bg-green-400 text-white w-full py-2 mt-4 rounded"
